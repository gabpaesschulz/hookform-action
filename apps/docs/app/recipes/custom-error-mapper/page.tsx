    ...
    <div className="max-w-4xl mx-auto px-6 py-16">
      ...
      <div className="mb-12">
        ...
        <p className="text-lg text-gray-400">
          ...
          <code>{`{ errors: { field: string[] } }`}</code>, use a custom <code>errorMapper</code> to translate them into
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-400 leading-relaxed">
          ...
          procedures — rarely return errors in the <code>{`{ errors: { field: string[] } }`}</code> format that{" "}
          <code>defaultErrorMapper</code> expects. Without a custom mapper, the hook cannot automatically set field
          errors and you end up writing manual <code>setSubmitError</code> calls all over your form components.
        </p>
        <p className="text-gray-400 leading-relaxed mt-3">
          The <code>errorMapper</code> option is a pure function defined once per form (or shared across forms hitting
          the same API). It receives the raw action result and returns a <code>FieldErrorRecord</code> that the hook
  ...
  "errors": {
    ...
    "password": ["The password must be at least 8 characters."]
            ...
            <p className="text-sm text-gray-500 mt-2">
              (Laravel-style — the <code>errors</code> values are arrays of strings, which happens to match the default
...
export function RegistrationForm() {
  ...
  // ...
        ...
        <div className="mb-5">
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-4 mb-4">
            <p className="text-sm text-gray-400 mb-2">
              <span className="text-gray-200 font-medium">A non-standard API (object-per-error format):</span>
            </p>
            <pre className="text-gray-300 text-sm">{`{
  "fieldErrors": {
    ...
    <form onSubmit={handleSubmit()}>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-3">
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-4">
            <code className="text-brand-400">errorMapper: (result) =&gt; FieldErrorRecord | null</code>
            <p className="text-gray-400 text-sm mt-1">
              A pure function that receives the raw action result (typed as <code>TResult</code>) and returns a{" "}
              <code>FieldErrorRecord</code> — a <code>Record&lt;string, string[] | undefined&gt;</code>. Return{" "}
              <code>null</code> or <code>undefined</code> when there are no errors. The hook calls <code>setError</code>{" "}
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-4">
            ...
            <p className="text-gray-400 text-sm mt-1">
              The <code>errorMapper</code> is compared by reference between renders. An inline arrow function creates a
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-4">
            ...
            <p className="text-gray-400 text-sm mt-1">
              ...
              from <code>formState.actionResult</code> and rendered separately — not through the field error system.
            </p>
          </div>
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-4">
            <code className="text-brand-400">Composing with defaultErrorMapper</code>
            <p className="text-gray-400 text-sm mt-1">
              You can import and call <code>defaultErrorMapper</code> inside your custom mapper as a fallback for fields
      ...
      <section className="mb-12">
        ...
        <ul className="space-y-3">
          <li className="flex gap-3 bg-yellow-500/5 border border-yellow-500/20 rounded-lg p-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400 mt-1">
                The hook checks if the returned object is truthy and has keys. An empty object <code>{`{}`}</code> is
                truthy, but all its field lookups return <code>undefined</code>. Return <code>null</code> or{" "}
                <code>undefined</code> explicitly when there are no errors to map.
              </p>
            </div>
          </li>
          <li className="flex gap-3 bg-yellow-500/5 border border-yellow-500/20 rounded-lg p-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400 mt-1">
                <code>{"errorMapper: (r) => ..."}</code> creates a new function on every render. Since the hook uses it
          ...
          <li className="flex gap-3 bg-yellow-500/5 border border-yellow-500/20 rounded-lg p-4">
            <span className="text-yellow-400 shrink-0 mt-0.5">⚠</span>
            <div>
              <p className="text-sm font-medium text-gray-200">Mapper receives the result even on success</p>
              <p className="text-sm text-gray-400 mt-1">
                <code>errorMapper</code> is called after every action invocation, including successful ones. Always add
                a guard (e.g. check for the presence of an error key) and return <code>null</code> for success
                responses.
              </p>
            </div>
          </li>
      ...
      <section className="border-t border-gray-800 pt-8">
        ...
        <div className="flex flex-wrap gap-4 text-sm">
          ...
          <a href="/recipes/standalone-fetch" className="text-brand-400 hover:text-brand-300 transition-colors">
