    ...
    <div className="max-w-4xl mx-auto px-6 py-16">
      ...
      <div className="mb-12">
        ...
        <p className="text-lg text-gray-400">
          The foundation pattern. Learn how <code>withZod</code>, <code>useActionForm</code>, and
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-400 leading-relaxed">
          ...
          the core mental model: a typed server action wrapped with <code>withZod</code>, a client
          component calling <code>useActionForm</code>, and a clean pattern for displaying both
          client-side validation errors and server-side errors on the same fields.
        </p>
        <p className="text-gray-400 leading-relaxed mt-3">
          Getting this right means understanding the difference between <code>isSubmitting</code>{' '}
          and <code>isPending</code>, knowing that <code>withZod</code> auto-attaches the schema for
    ...
    <form onSubmit={handleSubmit()}>
      ...
      <button type="submit" disabled={isPending}>
        ...
        <div className="bg-blue-500/5 border border-blue-500/20 rounded-lg p-4 text-sm text-gray-400">
          ...
          call <code>redirect(&apos;/dashboard&apos;)</code> from <code>next/navigation</code>{' '}
          inside <code>withZod</code>. The hook treats the thrown redirect as a successful
          submission — <code>isSubmitSuccessful</code> will be <code>true</code>, but the page will
        ...
        <div className="space-y-3">
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-4">
            ...
            <p className="text-gray-400 text-sm mt-1">
              ...
              <code>useActionForm</code> reads it automatically for client-side validation. On
              validation failure, returns <code>{'{ errors: { field: string[] } }'}</code> without
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-4">
            ...
            <p className="text-gray-400 text-sm mt-1">
              <code>isPending</code> reflects React&apos;s <code>useTransition</code> — it stays{' '}
              <code>true</code> for the full async round-trip to the server. Use it to disable the
              submit button. <code>isSubmitting</code> is the synchronous RHF snapshot and may not
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-4">
            ...
            <p className="text-gray-400 text-sm mt-1">
              ...
              <code>{'<form onSubmit={handleSubmit()}>'}</code>. Optionally pass an{' '}
              <code>onValid</code> callback that runs with typed data before the action is called:{' '}
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-4">
            ...
            <p className="text-gray-400 text-sm mt-1">
              Always provide <code>defaultValues</code>. Without them, RHF initialises fields as{' '}
              <code>undefined</code>, which causes React&apos;s uncontrolled-to-controlled warning
        ...
        <ul className="space-y-3">
          <li className="flex gap-3 bg-yellow-500/5 border border-yellow-500/20 rounded-lg p-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400 mt-1">
                Use <code>isPending</code> instead. In Next.js the action runs inside a transition,
                and <code>isSubmitting</code> may revert to <code>false</code> before the server
                response arrives.
              </p>
            </div>
          </li>
          <li className="flex gap-3 bg-yellow-500/5 border border-yellow-500/20 rounded-lg p-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400 mt-1">
                <code>redirect()</code> throws internally — the return statement is unreachable.
          ...
          <li className="flex gap-3 bg-yellow-500/5 border border-yellow-500/20 rounded-lg p-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400 mt-1">
                The default <code>errorMapper</code> only recognises that exact shape. If your
                action returns a different format, use a custom <code>errorMapper</code> — see{' '}
