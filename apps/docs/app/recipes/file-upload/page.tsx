    ...
    <div className="max-w-4xl mx-auto px-6 py-16">
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-400 leading-relaxed">
          ...
          <code>multipart/form-data</code>, not JSON. That means you need a <code>FormDataServerAction</code> instead of
          the <code>withZod</code> JSON wrapper. Validation also shifts: instead of a Zod schema on an object, you
          inspect the <code>File</code> object&apos;s <code>size</code>, <code>type</code>, and <code>name</code> on the
          server.
        </p>
        <p className="text-gray-400 leading-relaxed mt-3">
          Client-side validation (type/size checks before upload) is implemented with a custom <code>schema</code> using
          Zod&apos;s <code>.refine()</code>. This recipe covers the full pattern: action, form, preview, and a graceful
          loading state.
        </p>
      </section>
        ...
        <div className="space-y-3">
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-4">
            ...
            <p className="text-gray-400 text-sm mt-1">
              File uploads require the <code>(prevState, formData) =&gt; Promise</code> signature. The hook detects this
              automatically (by checking the function&apos;s <code>length</code>) and sends the data as{" "}
              <code>multipart/form-data</code> instead of JSON.
            </p>
          </div>
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-4">
            <code className="text-brand-400">z.custom&lt;FileList&gt;().refine()</code>
            <p className="text-gray-400 text-sm mt-1">
              Zod does not have a built-in file type. Use <code>z.custom&lt;FileList&gt;()</code> with{" "}
              <code>.refine()</code> for client-side validation. Avoid <code>z.instanceof(File)</code> — it fails in SSR
              environments where <code>File</code> is not defined.
            </p>
          </div>
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-4">
            ...
            <p className="text-gray-400 text-sm mt-1">
              ...
              <code>URL.revokeObjectURL</code> when the preview is no longer needed to prevent memory leaks. Store the
              URL in a <code>useRef</code> to access it across renders.
            </p>
          </div>
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-4">
            ...
            <p className="text-gray-400 text-sm mt-1">
              ...
              <code>experimental.serverActionsBodySizeLimit</code> in <code>next.config.mjs</code>, or upload directly
        ...
        <ul className="space-y-3">
          <li className="flex gap-3 bg-yellow-500/5 border border-yellow-500/20 rounded-lg p-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400 mt-1">
                <code>withZod</code> serialises data as JSON. Files cannot be serialised to JSON — you will receive an
          ...
          <li className="flex gap-3 bg-yellow-500/5 border border-yellow-500/20 rounded-lg p-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400 mt-1">
                Browser security prevents programmatically setting file input values. Use <code>register</code> normally
                and listen to <code>onChange</code> for the preview logic. Do not try to control the file input&apos;s
                value via <code>setValue</code>.
              </p>
            </div>
          </li>
          <li className="flex gap-3 bg-yellow-500/5 border border-yellow-500/20 rounded-lg p-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400 mt-1">
                Every <code>URL.createObjectURL</code> call holds a reference to the file in memory. Revoke it in{" "}
                <code>onSuccess</code> or in a <code>useEffect</code> cleanup to avoid memory leaks in long-running
                sessions.
              </p>
            </div>
          </li>
