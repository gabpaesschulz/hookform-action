        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div>
            ...
            <div className="code-block text-center">
              <code className="text-green-400">npm install next-action-form react-hook-form zod</code>
            </div>
          </div>
          <div>
            <p className="text-sm text-gray-400 mb-2 text-center">Vite / Remix / Astro (Standalone)</p>
            <div className="code-block text-center">
              <code className="text-green-400">npm install @next-action-form/standalone react-hook-form zod</code>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          <div className="bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 border border-emerald-500/20 rounded-xl p-6">
            ...
            <p className="text-gray-400 text-sm">
              The core logic no longer depends on Next.js. Use <code>@next-action-form/standalone</code> with Vite,
              Remix, Astro, or any React app.
            </p>
          </div>
          <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-xl p-6">
            ...
            <p className="text-gray-400 text-sm">
              <code>@next-action-form/devtools</code> — a floating debug panel showing form state, submission history,
              and debug actions. Inspired by TanStack Query DevTools.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-brand-500/10 to-cyan-500/10 border border-brand-500/20 rounded-xl p-6">
            ...
            <p className="text-gray-400 text-sm">
              Existing <code>next-action-form</code> v2 imports work exactly the same. The Next.js adapter is 100%
              backward-compatible.
            </p>
          </div>
        </div>
