...
import type { ActionResult, FieldErrorRecord, ZodServerAction } from "./types";
...
): ((data: unknown) => Promise<TResult | { success: false; errors: FieldErrorRecord }>) & { __schema: TSchema } {
