...
function createSuccessSubmit(): SubmitFunction<Record<string, unknown>, { success: true; data: string }> {
...
function createErrorSubmit(): SubmitFunction<Record<string, unknown>, { errors: { email: string[] } }> {
  return vi.fn(async (_data: Record<string, unknown>) => ({
